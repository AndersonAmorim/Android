package com.markoarsenovic.sharedpreferences;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void showAlert() {
        ...
        new AlertDialog.Builder(this)
                ...
                .setMessage("Do you want English or Serbian?")
                ...
                .setNegativeButton("Serbian", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        sharedPreferences.edit().putString("language", "serbian").apply();
                        textView.setText("serbian");
                    }
                })
                .show();
